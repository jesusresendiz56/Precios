...
<body>
    ...
    <script>
        // Cargar productos de Walmart al iniciar
        ...
        function mostrarProductosWalmart(productos) {
            ...
            for (const [categoria, productosCategoria] of Object.entries(productosPorCategoria)) {
                const icono = categoria.split(' ')[0]; // Tomar el emoji del inicio
                const nombreCategoria = categoria.replace(/^[^\w\s]*\s/, ''); // Remover el emoji del nombre
